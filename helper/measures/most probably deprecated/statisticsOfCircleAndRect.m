...
if(SAVEIMAGE)
    ...
    imgGray = logOfBase(mean2(img),img);
    imgGray = mat2gray(imgGray, [0 double(max(max(imgGray)))]);
    ...
    imwrite(imgGray,strcat(savePath,DELIMITER,filename),'png');
    imshow(imgGray,[]);
end

%TODO implement this properly
meanBackgroundTwoDegree = 0;
